...
y_train <- sin(x_train*2)+2+epsilon_train  # train set
y_train_no_error <- sin(x_train*2)+2
...
y_test <- sin(x_test*2)+2+epsilon_test     # test set
...
lines(seq(-2.5,2.5,0.1), sin(seq(-2.5,2.5,0.1)*2)+2, col='black', lwd=2) # true relationship.. 
